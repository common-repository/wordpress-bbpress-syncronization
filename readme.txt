...
**bbPress part may be downloaded [here](http://bbpress.org/plugins/topic/wordpress-bbpress-syncronization/)**
...
*  Huh, stupid typo: sync_h_ronization. it will be feature, not bug :)
